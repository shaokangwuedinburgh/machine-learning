...
from utils import accuracy, samples, save_img
...
if __name__ == '__main__':
    ...
    for i in range(len(epsilons)):
        ...
        rs_path = r_save_path + str(epsilons[i]) + '/'
        ...
        batch_size = advs_.shape[0]
        for j in range(batch_size):
            img_path = imgs_path + file_names[j]
            attack_label = attack_labels[j]
            cls = imagenet_dict[attack_label]
            # save_img(advs_[j].unsqueeze(0), img_path, (1, 1))
            save_img(advs_[j].unsqueeze(0), img_path, (1, 1), cls)


        for j in range(batch_size):
            r_path = rs_path + file_names[j]
            save_img(rs_[j].unsqueeze(0), r_path, (1, 1))
